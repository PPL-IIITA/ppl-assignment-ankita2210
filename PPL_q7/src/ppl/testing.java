...
/**
 * @see testing helps in solving q7
 *
 * 
 * 
 */
...
public class testing {
   /** fnc1 returns couple's object array 
...
// instantiating the gifts objects
  ...
  */ 
    ...
    */
    ...
    gift_selector object=new gift_selector();
    int[] cost_of_gifts=new int[12];
    long[] happ=new long [12];
    int[] comp=new int[12];
    int z=rand_Generator.nextInt(2);
    System.out.println("z= "+ z);
    if(z==0)
    cost_of_gifts=object.gift_basket(c, 12, ess, util, lux);
    else{
        
    System.out.println("Special gifting done :");
    cost_of_gifts=object.special_gifting(c, 12, ess, util, lux);    
