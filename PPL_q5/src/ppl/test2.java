...
/**
 *
 * @see test2 class creating gift basket and calculating  happiness for a couple
 */
public class test2 {
    /** A method for exchanging 
       of gifts between the couples for t (here t=15) calendar days according to the 
       type of boy 
