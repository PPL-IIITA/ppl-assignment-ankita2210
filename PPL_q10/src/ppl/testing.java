...
public class testing {
   /**This function generates a random item out of the best k(here 5) items and forms couples according to it .If the girl and randomly generated boy (among top
    * k) are not compatible couple is not formed .
...
// instantiating the gifts objects
  ...
  */ 
    ...
    */
    ...
    cost_of_gifts=object.gift_basket(c, c.length, ess, util, lux);
